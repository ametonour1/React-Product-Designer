    ...
    <motion.div  className="flex flex-col  gap-10 pl-5 pr-5 pt-32 pb-32 sm:pl-16 sm:pr-16 lg:flex-row lg:pl-2 lg:pr-2 justify-center items-baseline bg-inherit ">
       <InfoAnimationWrapper>
        <div className='flex flex-1 h-full  flex-col justify-evenly gap-3 mt-3  '>
            ...
            <p className="text-xl text-textBaseColor font-light text-justify   ">We Provide Delivery Within 3 Working Days For Orders In Europe, For International Orders We Guarentee Delivey Within 2 Weeks.</p>
        </div>
        </InfoAnimationWrapper>
        <InfoAnimationWrapper>
        <div className='flex flex-1 h-full   flex-col justify-evenly gap-3 mt-3  '>
            ...
            <p className="text-xl text-textBaseColor font-light text-justify   ">We Implenent Payment gateways That Are The Best In Bussiness To Ensure The Security Of Our Customers, If The Customer Is Unsatisfied We Provide Money Back Guarantee.</p>
        </div>
        </InfoAnimationWrapper>
        <InfoAnimationWrapper>
        <div className='flex flex-1 h-full  flex-col justify-evenly gap-3  mt-3'>
            ...
            <p className="text-xl text-textBaseColor font-light text-justify   ">We Work With Products Sourced Only From Ethical Producers, And Select Only The Best Quality Products For Our Customers Ensuring The Printing Is Done To Pixel Perfection.</p>
        </div>
        </InfoAnimationWrapper>
    </motion.div>
  )
