...
import { addProductToFirestore,fetchProductsFromFirestore, } from '../../firebase/firebaseAuth'
const AdminPage = () => {
    ...
    <div className="h-full  flex flex-row-reverse bg-inherit">
     <div className="flex-1 bg-backgroundColorPrimary">
      ...
      <AdminCanvasSliders
        ...
        <button className="bg-red-600" onClick={()=>fetchProductsFromFirestore(productCategory)}>test</button>
